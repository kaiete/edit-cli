...
if editoropen == "v":
    ...
    if input("Are you ABSOLUTELY SURE? The file's contents will be gone INDEFINITELY! If the original file is small in size, the corrupted file is not based on the original, and may be bigger! (y/N)") == "y":
        ...
        y = random.randint(1,100101010147859723578650684086498348645864868543638574867948567094670945678567506730565605638456546757866587546868795679378476384654858436346846745754674585684754094567857689760863)
